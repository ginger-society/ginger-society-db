...
class service(models.Model):
    ...
    db_schema_id = models.CharField(
        max_length=100,
        blank=True,
        null=True,
    )

    tables_json = models.CharField(
        max_length=1000,
        blank=True,
        null=True,
    )

    dependencies_json = models.CharField(
        max_length=1000,
        blank=True,
        null=True,
    )
    ...
    cache_schema_id = models.CharField(
        max_length=250,
        blank=True,
        null=True,
    )
    ...
    message_queue_schema_id = models.CharField(
        max_length=150,
        blank=True,
        null=True,
    )
...
class organization(models.Model):
    ...
    blocks_positions = models.TextField(
        max_length=40000,
        null=True,
    )
    ...
    infra_repo_origin = models.CharField(
        max_length=200,
        blank=True,
        null=True,
    )
